...
function generateDatePanelHTML(idPrefix, onChangeFuncName, extraHtml = "") {
    ...
    // ИСПРАВЛЕНО: Тотальное флекс-центрирование иконки строго по центру кнопки 36х36px
    let empBtnHtml = "";
    ...
    modal.innerHTML = `
        <div class="card" style="width:100%; max-width:340px; background:var(--card-bg); padding:16px; border-radius:16px; box-shadow:0 8px 24px rgba(0,0,0,0.2); border:1px solid var(--border-color); display:flex; flex-direction:column; box-sizing:border-box; overflow:hidden; animation:slide-up-fade 0.2s ease;" onclick="event.stopPropagation();">
            ...
            <div id="block-ov-hours" style="display:block; width:100%; box-sizing:border-box;">
                ...
                <div style="display: flex; gap: 10px; align-items: center; justify-content: space-between; margin-bottom: 12px; width: 100%; height: 38px; box-sizing: border-box;">
                    <div style="display: flex; align-items: center; gap: 6px; flex: 1; height: 100%; min-width: 0;">
                        <span style="font-size: 11px; color: gray; font-weight: bold; white-space: nowrap; display: flex; align-items: center; height: 100%;">С:</span>
                        <input type="time" id="ov-hours-from" style="flex: 1; min-width: 0; height: 38px; background: var(--inner-bg); border: 1.5px solid #f39c12; color: var(--text-color); border-radius: 8px; padding: 0 4px; font-size: 13px; font-weight: bold; font-family: inherit; display: inline-flex; align-items: center; justify-content: center; text-align: center; text-align-last: center; box-sizing: border-box; margin: 0; -webkit-appearance: none; appearance: none;">
                    </div>
                    
                    <span style="color: gray; font-weight: bold; font-size: 14px; display: flex; align-items: center; height: 100%; flex-shrink: 0;">-</span>
                    
                    <div style="display: flex; align-items: center; gap: 6px; flex: 1; height: 100%; min-width: 0;">
                        <span style="font-size: 11px; color: gray; font-weight: bold; white-space: nowrap; display: flex; align-items: center; height: 100%;">До:</span>
                        <input type="time" id="ov-hours-to" style="flex: 1; min-width: 0; height: 38px; background: var(--inner-bg); border: 1.5px solid #f39c12; color: var(--text-color); border-radius: 8px; padding: 0 4px; font-size: 13px; font-weight: bold; font-family: inherit; display: inline-flex; align-items: center; justify-content: center; text-align: center; text-align-last: center; box-sizing: border-box; margin: 0; -webkit-appearance: none; appearance: none;">
                    </div>
                </div>
            </div>
